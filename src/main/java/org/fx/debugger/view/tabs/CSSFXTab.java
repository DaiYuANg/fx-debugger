...
import org.fx.debugger.view.cssfx.CSSFXTabContentController;
import org.fx.debugger.view.cssfx.MonitoredCSS;
...
public class CSSFXTab extends Tab {
  ...
  private Map<StageID, ObservableList<MonitoredCSS>> cssByStage =
      new HashMap<StageID, ObservableList<MonitoredCSS>>();
  ...
  private Node createTabGraphic() {
    ...
    p.setContent(
        "m 180.75256,334.77228 -0.53721,2.68603 10.93285,0 -0.3412,1.73502 -10.9401,0 -0.52996,2.68603 10.93286,0 -0.6098,3.06352 -4.40654,1.45917 -3.81851,-1.45917 0.26134,-1.32849 -2.68602,0 -0.63884,3.22323 6.31579,2.41742 7.2813,-2.41742 0.96552,-4.84937 0.19601,-0.97277 1.24138,-6.2432 z");
