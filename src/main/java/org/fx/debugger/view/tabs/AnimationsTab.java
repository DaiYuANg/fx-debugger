...
import org.fx.debugger.fxconnector.SVAnimation;
...
public class AnimationsTab extends Tab implements ContextMenuContainer {
  ...
  public void update(final StageID stageID, final List<SVAnimation> animations) {
    ...
    for (final Iterator<Integer> iterator = appsAnimations.keySet().iterator();
        iterator.hasNext(); ) {
      ...
      cycleCountCol.setCellValueFactory(
          new PropertyValueFactory<SVAnimation, String>("cycleCount"));
      final TableColumn<SVAnimation, String> currentTimeCol = new TableColumn<>("Current time");
      currentTimeCol.setCellValueFactory(
          new PropertyValueFactory<SVAnimation, String>("currentTime"));
      ...
      pauseCol.setCellFactory(
          new Callback<TableColumn<SVAnimation, Integer>, TableCell<SVAnimation, Integer>>() {

            @Override
            public TableCell<SVAnimation, Integer> call(
                final TableColumn<SVAnimation, Integer> arg0) {
              final TableCell<SVAnimation, Integer> cell =
                  new TableCell<SVAnimation, Integer>() {
                    @Override
