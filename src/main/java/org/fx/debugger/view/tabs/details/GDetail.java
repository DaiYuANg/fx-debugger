 ...
 */
package org.fx.debugger.view.tabs.details;
...
import org.fx.debugger.fxconnector.details.Detail;
import org.fx.debugger.fxconnector.details.DetailPaneType;
import org.fx.debugger.fxconnector.details.GridConstraintsDetail;
...
public class GDetail {
  ...
  public void setIsDefault(final boolean isDefault) {
    ...
    final boolean showDetail =
        (!DetailsTab.showDefaultProperties && !isDefault) || DetailsTab.showDefaultProperties;
  ...
  public void setEditionType(final Detail.EditionType editionType) {
      ...
      case GRID_CONSTRAINTS:
        {
          ...
          for (final Iterator<GridConstraintsDetail> iterator = constraints.iterator();
              iterator.hasNext(); ) {
  ...
  public String toString() {
    return label.getText()
        + "="
        + ((value instanceof Label) ? ((Label) value).getText() : value.toString());
  }
}
