 ...
 */
package org.fx.debugger.view.cssfx;
...
public class CSSFXTabContentController {
  ...
  public void initialize() {
    ...
    monitoredCSS.addListener(
        new ChangeListener<ObservableList<MonitoredCSS>>() {
          @Override
          public void changed(
              ObservableValue<? extends ObservableList<MonitoredCSS>> observable,
              ObservableList<MonitoredCSS> oldValue,
              ObservableList<MonitoredCSS> newValue) {
            if (newValue == null) {
                  ...
                  new ChangeListener<Object>() {
                    ...
                    public void changed(
                      ...
                      filteredData.setPredicate(
                          new Predicate<MonitoredCSS>() {
                            @Override
                            public boolean test(MonitoredCSS t) {
                              boolean isEmpty =
                                  t.getMappedBy() == null || "".equals(t.getMappedBy());
