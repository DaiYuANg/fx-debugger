 ...
 */
package org.fx.debugger.view.control;
    ...
    setOnAction(
        new EventHandler<ActionEvent>() {
          ...
          public void handle(final ActionEvent arg0) {
            ...
            //                try {
            //                    final Field field =
            // CustomColorDialog.class.getDeclaredField("customColorProperty");
            //                    field.setAccessible(true);
            //                    @SuppressWarnings("unchecked") final ObjectProperty<Color> color =
            // (ObjectProperty<Color>) field.get(dialog);
            //                    color.addListener(new ChangeListener<Color>() {
            //
            //                        @Override public void changed(final ObservableValue<? extends
            // Color> arg0, final Color arg1, final Color newValue) {
            //                            setColor(newValue);
            //                        }
            //                    });
            ...
            //
            //                    @Override public void changed(final ObservableValue<? extends
            // Number> arg0, final Number arg1, final Number newValue) {
            ...
            //                        final double value =
            // ConnectorUtils.parse(sliderValue.getText());
