 ...
 */
package org.fx.debugger.attach;

import static org.fx.debugger.view.ScenicView.JDK_PATH_KEY;
...
import org.fx.debugger.utils.Utils;
...
public class AttachHandlerFactory {
  ...
  public static void initAttachAPI(final Stage stage) {
    ...
    if (needAttachAPI) {
      /**
       * This needs to be improved, in this situation we already have attachAPI but not because it
       * was saved in the file, try to fill the path by finding it
       */
