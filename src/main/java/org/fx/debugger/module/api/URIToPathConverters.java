 ...
 */
package org.fx.debugger.module.api;
        ...
        public Path apply(String uri) {
          Path p =
              new SubstringFileMapper(uri)
                  ...
                  .resolve();
          if (p == null) {
            CSSFXLogger.logger(URIToPathConverters.class)
                .debug("MAVEN converter failed to map css[%s] to a source file", uri);
          }
  ...
  private static final Function<String, Path> GRADLE_RESOURCE =
      new Function<String, Path>() {
        ...
        public Path apply(String uri) {
          ...
          if (p == null) {
            CSSFXLogger.logger(URIToPathConverters.class)
                .debug("GRADLE converter failed to map css[%s] to a source file", uri);
          }
  ...
  private static final Function<String, Path> JAR_RESOURCE =
      new Function<String, Path>() {
        ...
        public Path apply(String uri) {
          ...
          CSSFXLogger.logger(URIToPathConverters.class)
              .debug("JAR converter failed to map css[%s] to a source file", uri);
          return null;
        }
      };
