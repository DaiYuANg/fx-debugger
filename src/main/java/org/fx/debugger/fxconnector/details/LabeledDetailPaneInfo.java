...
class LabeledDetailPaneInfo extends DetailPaneInfo {
  ...
  protected void updateDetail(final String propertyName) {
    ...
    if (all || propertyName.equals("graphicTextGap")) {
      ...
      graphicTextGapDetail.setSimpleProperty(
          labeled != null ? labeled.graphicTextGapProperty() : null);
      if (!all) graphicTextGapDetail.updated();
      if (!all) return;
    }
    if (all || propertyName.equals("alignment")) {
      ...
      alignmentDetail.setEnumProperty(
          labeled != null ? labeled.alignmentProperty() : null, Pos.class);
    ...
    if (all || propertyName.equals("textAlignment")) {
      ...
      textAlignmentDetail.setEnumProperty(
          labeled != null ? labeled.textAlignmentProperty() : null, TextAlignment.class);
      if (!all) textAlignmentDetail.updated();
      if (!all) return;
    }
    if (all || propertyName.equals("textOverrun")) {
      ...
      textOverrunDetail.setEnumProperty(
          labeled != null ? labeled.textOverrunProperty() : null, OverrunStyle.class);
      if (!all) textOverrunDetail.updated();
      if (!all) return;
    }
    if (all || propertyName.equals("contentDisplay")) {
      ...
      contentDisplayDetail.setEnumProperty(
          labeled != null ? labeled.contentDisplayProperty() : null, ContentDisplay.class);
      if (!all) contentDisplayDetail.updated();
      if (!all) return;
    }
