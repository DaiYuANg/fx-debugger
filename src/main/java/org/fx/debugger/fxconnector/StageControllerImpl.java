 ...
 */
package org.fx.debugger.fxconnector;
...
import org.fx.debugger.fxconnector.details.AllDetails;
import org.fx.debugger.fxconnector.details.DetailPaneType;
import org.fx.debugger.fxconnector.event.AnimationsCountEvent;
import org.fx.debugger.fxconnector.event.EvCSSFXEvent;
import org.fx.debugger.fxconnector.event.EvLogEvent;
import org.fx.debugger.fxconnector.event.FXConnectorEvent;
import org.fx.debugger.fxconnector.event.FXConnectorEventDispatcher;
import org.fx.debugger.fxconnector.event.MousePosEvent;
import org.fx.debugger.fxconnector.event.NodeAddRemoveEvent;
import org.fx.debugger.fxconnector.event.NodeCountEvent;
import org.fx.debugger.fxconnector.event.NodeSelectedEvent;
import org.fx.debugger.fxconnector.event.SceneDetailsEvent;
import org.fx.debugger.fxconnector.event.ShortcutEvent;
import org.fx.debugger.fxconnector.event.WindowDetailsEvent;
import org.fx.debugger.fxconnector.gui.ComponentHighLighter;
import org.fx.debugger.fxconnector.gui.RuleGrid;
import org.fx.debugger.fxconnector.helper.ChildrenGetter;
import org.fx.debugger.fxconnector.helper.StyleSheetRefresher;
import org.fx.debugger.fxconnector.helper.SubWindowChecker;
import org.fx.debugger.fxconnector.node.NodeType;
import org.fx.debugger.fxconnector.node.SVDummyNode;
import org.fx.debugger.fxconnector.node.SVNode;
import org.fx.debugger.fxconnector.node.SVNodeFactory;
import org.fx.debugger.module.api.CSSFXEvent;
import org.fx.debugger.module.api.CSSFXEvent.EventType;
import org.fx.debugger.module.api.MonitoredStylesheet;
import org.fx.debugger.utils.SCUtils;
...
public class StageControllerImpl implements StageController {
  ...
  private void setTarget(final Parent value) {
    ...
    if (overlayParent == null) {
      log.atInfo().log(
          "warning: could not find writable parent to add overlay nodes; overlays disabled.");
  ...
  private Consumer<CSSFXEvent<?>> eventTranslator =
      new Consumer<CSSFXEvent<?>>() {
        ...
        private FXConnectorEvent.SVEventType fromCSSEvent(EventType et) {
          switch (et) {
            case STYLESHEET_MONITORED:
              return FXConnectorEvent.SVEventType.CSS_ADDED;
            case STYLESHEET_REMOVED:
              return FXConnectorEvent.SVEventType.CSS_ADDED;
            case STYLESHEET_REPLACED:
              return FXConnectorEvent.SVEventType.CSS_ADDED;
