...
public interface RemoteApplication extends Remote {
  ...
  public void configurationUpdated(final StageID id, Configuration configuration)
      throws RemoteException;

  public void update(final StageID id) throws RemoteException;

  public void setEventDispatcher(final StageID id, FXConnectorEventDispatcher dispatcher)
      throws RemoteException;
  ...
  public void setDetail(StageID id, DetailPaneType detailType, int detailID, String value)
      throws RemoteException;
