...
import org.fx.debugger.fxconnector.helper.FXUtils;
...
import org.fx.debugger.module.api.URIToPathConverters;
import org.fx.debugger.module.impl.CSSFXMonitor;
import org.fx.debugger.module.impl.log.CSSFXLogger;
import org.fx.debugger.module.impl.log.CSSFXLogger.LogLevel;
                    ...
                    cssMonitor.allKnownStylesheets().stream()
                        .filter(
                            t -> {
                              ...
                              // TODO weakness: stages/window are identified with root of scene
                              // (that can change)
                        ...
                        .forEach(
                            ms ->
                                sciEventListener.accept(
                                    CSSFXEvent.newEvent(EventType.STYLESHEET_MONITORED, ms)));
                  }
                });
          }
