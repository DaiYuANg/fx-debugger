...
public class ScenicView extends Application {
  ...
  private BeanScope beanScope = BeanScope.builder().build();
            ...
            () -> {
              while (true) {
                try {
                  ...
                  // FX runtime hasn't been initialized yet. Actual initialization occurs in method
                  // LauncherImpl.startup()
                  // which must be called only once and under normal circumstances called as result
