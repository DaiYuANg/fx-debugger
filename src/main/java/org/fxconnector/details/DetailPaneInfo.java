...
abstract class DetailPaneInfo {
  ...
  final void clear() {
    ...
    dispatcher.dispatchEvent(
        new DetailsEvent(SVEventType.DETAILS, stageID, type, getPaneName(), empty));
  }
  ...
  protected final Detail addDetail(
      final String property, final String label, final ValueType type) {
  ...
  protected final Detail addDetail(
      final String property, final String label, final LabelType type) {
    final Detail detail = new Detail(dispatcher, stageID, this.type, id++);
    detail.setProperty(property);
    detail.setLabel(label);
  ...
  final void sendAllDetails() {
    dispatcher.dispatchEvent(
        new DetailsEvent(SVEventType.DETAILS, stageID, type, getPaneName(), details));
  }
